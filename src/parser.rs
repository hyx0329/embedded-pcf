...
pub struct MetricsEntry {
    ...
    pub(crate) right_side_bearing: i16,
    pub(crate) character_width: i16,
    pub(crate) character_ascent: i16,
    pub(crate) character_descent: i16,
    pub(crate) character_attributes: u16,
}
